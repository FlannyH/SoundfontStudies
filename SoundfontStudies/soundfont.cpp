        ...
        for (uint16_t preset_zone_index = preset_zone_start; preset_zone_index < zone_end; preset_zone_index++) {
            ...
            for (uint16_t instrument_index = instrument_start; instrument_index < instrument_end; instrument_index++) {
                ...
                Zone new_zone_to_add{
                    ...
                    final_zone_generator_values["startAddrsOffset"].s_amount,
                    final_zone_generator_values["endAddrsOffset"].s_amount,
                    final_zone_generator_values["startloopAddrsOffset"].s_amount,
                    final_zone_generator_values["endloopAddrsOffset"].s_amount,
